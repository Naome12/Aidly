  ...
  return (
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View className="flex-1 p-6">
        ...
        style={{
          textShadowColor: 'rgba(0, 0, 0, 0.6)', // Color of the shadow (dark shadow)
        ...
        <TouchableOpacity
          className="p-4 mt-2 flex flex-row items-center"
          onPress={handleGoogleLogin}
          >
          <Text className="text-white">Or Sign Up with </Text>
          <Text className="text-blue-400 font-bold">Google</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          >
          <Text className="text-white">Drag right to</Text>
