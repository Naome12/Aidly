    ...
    <View className="flex-1 bg-black px-4 pt-10">
      ...
      <ScrollView className="mt-6">
          ...
          {languages.map((lang) => (
            <TouchableOpacity
              ...
              className={`px-4 py-2 rounded-lg m-1 ${
                selectedLanguage === lang.name ? "bg-red-500" : "bg-gray-800"
              }`}
          ...
          {genders.map((gender) => (
            <TouchableOpacity
              ...
              className={`px-6 py-2 rounded-lg ${
                selectedGender === gender.label ? "bg-red-500" : "bg-gray-800"
              }`}
        ...
        <View className="flex-row justify-between mt-8">
          <TouchableOpacity className="bg-gray-700 px-6 py-3 rounded-lg">
